...
from plot_actual_vs_gumbel_spike_removed import (
    DEFAULT_NUM_SAMPLES,
    DEFAULT_SEED,
    DEFAULT_SOURCE_BS,
    DEFAULT_SOURCE_EP,
    ...
    predict_gumbel_distribution_spike_removed_all_layers,
    predict_gumbel_distribution_spike_removed_for_layer,
    remove_bin_and_renormalize,
    tvd_from_dists,
)
...
OUTPUT_DIR = "./output/actual_vs_gumbel_max_lg_spike_removed"
...
def main():
    ...
    stem = (
        f"actual_vs_gumbel_max_lg_spike_removed_ep{ep_size}_bs{batch_size}"
